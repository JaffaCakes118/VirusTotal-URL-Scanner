...
* **Privacy-Focused**: Only sends URLs to VirusTotal; no other personal browsing data is collected or transmitted by the extension developer.
...
1.  **Install from Chrome Web Store**:
    ...
    * Go to the VirusTotal URL Scanner page on the Chrome Web Store.
